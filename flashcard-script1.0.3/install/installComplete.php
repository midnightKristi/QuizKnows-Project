		...
		<div class="row">
            <div class="col-md-2">
            	<div class="install_step">
            		<ul>
		            	...
		            	<li><i class="fa fa-check">&nbsp;&nbsp;</i>Create admin</li>
            ...
            <div class="col-md-10">
            	<div class="install_content">
            		<p style="font-size: 18px;">You have successfully installed the Avrasys Vocabulary Builder Script</p>
            		<br>
            		<p><input type="checkbox" id="checkbox">&nbsp;&nbsp;For security purposes click here to remove the install directory.</p>
                <br>
            		<p><b>You can access the script :</b> <a href="#" id="siteUrl" onclick="goSite();"></a></p>
            	</div>
            </div>
        </div>
	</section>
